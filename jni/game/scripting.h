...
const SCRIPT_COMMAND create_player						= { 0x0053, "vfffv" }; 	// 0, x, y, z, $PLAYER_actor

const SCRIPT_COMMAND create_actor 						= { 0x009A, "iifff" };

const SCRIPT_COMMAND kill_actor							= { 0x0321, "i" };

const SCRIPT_COMMAND create_actor_from_player			= { 0x01F5, "vv" };		// PLAYER_actor, PLAYER_ACTOR
...
const SCRIPT_COMMAND give_weapon_to_actor				= { 0x01B2, "iii" };	// playerchar, weapon, ammo

const SCRIPT_COMMAND set_current_actor_weapon			= { 0x01B8, "ii" };	// weapon, ammo

const SCRIPT_COMMAND set_current_player_weapon			= { 0x01B9, "ii" };	// weapon, ammo

const SCRIPT_COMMAND set_render_player_weapon			= { 0x0A38, "" };

const SCRIPT_COMMAND remove_all_actor_weapons			= { 0x048F, "i" };

const SCRIPT_COMMAND get_weapontype_slot				= { 0x0782, "i" };

const SCRIPT_COMMAND get_current_actor_weapon			= { 0x0470, "i" };
...
const SCRIPT_COMMAND set_actor_proofs 					= { 0x02AB, "iiiiii" };

const SCRIPT_COMMAND set_actor_collision				= { 0x0619, "ii" };
...
const SCRIPT_COMMAND get_actor_weapon_in_slot			= { 0x04B8, "i" };

const SCRIPT_COMMAND is_actor_holding_weapon				= { 0x02D8, "ii"};

const SCRIPT_COMMAND is_actor_playing_anim				= { 0x0611, "is" };
...
const SCRIPT_COMMAND get_actor_speed						= { 0x06AC, "i" }; // actor handle

const SCRIPT_COMMAND set_actor_anim_speed				= { 0x0393, "isf" }; // actor handle, anim name, speed (1.0 normal)
...
const SCRIPT_COMMAND get_ammo_in_actor_weapon			= { 0x041A, "ii" }; // weapon id, actor handle [returns ammo(int)]

const SCRIPT_COMMAND set_actor_accuracy					= { 0x02E2, "ii" }; // actor handle, accuracy (int) ex 75
...
const SCRIPT_COMMAND get_actor_coordinates				= { 0x00A0, "i" }; // actor handle (returns float(3))
...
const SCRIPT_COMMAND is_actor_in_air						= { 0x0818, "i" }; // actor handle

const SCRIPT_COMMAND set_actor_heading					= { 0x0173, "ii" }; // actor handle, rot

const SCRIPT_COMMAND get_actor_heading					= { 0x0172, "i" }; // actor handle
...
const SCRIPT_COMMAND set_actor_never_targetted			= { 0x0568, "ii" }; // actor handle, state

const SCRIPT_COMMAND add_ammo_to_actor					= { 0x0114, "iii" }; // actor handle, weapon handle, ammo count

const SCRIPT_COMMAND set_actor_ammo						= { 0x017B, "iii" }; // actor handle, weapon handle, ammo count
...
const SCRIPT_COMMAND add_vehicle_mod					= { 0x06E7, "iiv" };	// iVehicle, component ID

const SCRIPT_COMMAND has_vehicle_mod_loaded				= { 0x06EA, "i" }; // componentid

const SCRIPT_COMMAND request_vehicle_mod				= { 0x06E9, "i" }; // componentid

const SCRIPT_COMMAND remove_vehicle_mod					= { 0x06E8, "ii" }; // iVehicle, component ID

const SCRIPT_COMMAND set_car_numberplate				= { 0x0674, "is" }; // iVehicle, szNumberPlate
...
const SCRIPT_COMMAND actor_task_handsup					= { 0x05c4, "ii" };

const SCRIPT_COMMAND actor_task_use_atm					= { 0x05c7, "ii" };
