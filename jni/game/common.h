...
typedef struct _PED_TYPE
{
	...
	uint32_t dwWeaponUsed;
	uint32_t dwPlayerInfoOffset; // 1152-1156
...
typedef struct _VEHICLE_TYPE
{
	...
	uint32_t * VehicleAttachedFront;  // 1488-1492
	uint32_t * VehicleAttachedBottom; // 1492-1498
	uint32_t dwTrainUnk;	 // 1440-1444
