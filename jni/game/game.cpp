...
uint32_t CGame::CreateWeaponPickup(int iModel, uint32_t dwAmmo, float fX, float fY, float fZ)
{
	Log("CreateWeaponPickup(%d, %d, %4.f, %4.f, %4.f)", iModel, dwAmmo, fX, fY, fZ);
	uint32_t hnd;
...
void CGame::DisplayGameText(char* szStr, int iTime, int iType)
{
	...
	AsciiToGxtChar(szStr, szGameTextMessage);
...
{
	//return (( void (*)(char*))(g_libGTASA+0x395E20+1))(szIPLLine);
}
