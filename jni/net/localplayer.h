...
typedef struct _INCAR_SYNC_DATA
{
	...
	uint8_t byteTires[4];
	uint8_t byteLightState;
	VEHICLEID TrailerID;			// +57
	uint32_t dwHydraThrustAngle;
...
private:
	...
	uint32_t			m_dwLastPanelDamageStatus;
	uint32_t			m_dwLastDoorDamageStatus;
	uint8_t				m_byteLastLightsDamageStatus;
