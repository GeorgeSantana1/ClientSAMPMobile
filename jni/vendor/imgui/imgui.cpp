...
ImGuiStyle::ImGuiStyle()
{
    ...
    FrameBorderSize         = 0.5f;             // Thickness of border around frames. Generally set to 0.0f or 1.0f. Other values not well tested.
    ...
    DisplayWindowPadding    = ImVec2(19, 19);    // Window positions are clamped to be visible within the display area by at least this amount. Only covers regular windows.
